      ...
      if (userData.orgId) {
        ...
        showSnap.docs.forEach(doc => {
          ...
          byId.set(doc.id, {
            ...
            ...(data.slideStorageVersion !== undefined && { slideStorageVersion: data.slideStorageVersion }),
            ...(data.publishedStorage && { publishedStorage: data.publishedStorage }),
            ...(Number.isFinite(data.publishedSlidesCount) && { publishedSlidesCount: data.publishedSlidesCount }),
            ...(data.draftStorage && { draftStorage: data.draftStorage }),
            ...(Number.isFinite(data.draftSlidesCount) && { draftSlidesCount: data.draftSlidesCount }),
